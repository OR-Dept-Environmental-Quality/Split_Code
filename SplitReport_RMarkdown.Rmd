...
spltorg<-params$org
spltorgnm<-unique(spltorg$OrganizationID)
...
knitr::include_graphics("C:/Users/dbrown/Split_Code/DEQ-logo-color-notransp-horiz750x156.png")
#
```
...
names(sublab)<-c("Station","Analyte","Result_Text","Unit","Method","Subcontract Lab")
