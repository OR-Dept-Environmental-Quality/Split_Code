...
if (is.numeric(spltcomp$MDLValue)) {spltcomp$Result.split<-ifelse(substr(spltcomp$Result.split,start=1,stop=1)!="<" & (as.numeric(spltcomp$Result.split)<=spltcomp$MRLValue.split) ,paste0(spltcomp$Result.split," J"),spltcomp$Result.split)}
