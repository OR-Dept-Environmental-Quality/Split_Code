...
source("//deqhq1/ABRITS/GitHub/Split_Code/ParamGrp_Function.R")
source("//deqhq1/ABRITS/GitHub/Split_Code/QC_Issue.R")
```
...
knitr::include_graphics("//deqhq1/ABRITS/GitHub/Split_Code/DEQ-logo-color-notransp-horiz750x156.png")
#
```
...
spltcomp$Result.split<-ifelse(substr(spltcomp$Result.split,start=1,stop=1)!="<" & (as.numeric(spltcomp$Result.split)<=spltcomp$MRLValue.split) ,paste0(spltcomp$Result.split," J"),spltcomp$Result.split)
...
sublab<-subset(sublab,sublab$Analytical_Lab!="DEQ Laboratory and Environmental Assessment Div.",select=c("MLocID","Char_Name","Result","Result_Unit","Method_Code","Analytical_Lab"))
