...
if(unique(spltorg$Project1)=="Effluent Monitoring") {
 ...
 if(nrow(iss)>0)
   {kable(iss,format='latex',col.names=c("Location","Analyte","DEQ","Split Lab","Unit","RPD","Diff"), caption="Outside of acceptable criteria limits",booktabs=TRUE,row.names=FALSE,longtable=TRUE)%>%
...
if(unique(spltorg$Project1)=="Landfill Monitoring") {
#Metals  #NOT SHOWING UP-NAMES DON'T MATCH DUE TO namefrac function being used to do split
...
if(unique(spltorg$Project1)=="Landfill Monitoring" & nrow(phys)==0 & nrow(metals)==0 & nrow(semivol)==0 & nrow(voc)==0) 
