...
logo <- "C:/Users/dbrown/Split_Code/DEQ-logo-color-notransp-horiz750x156.png"
```
...
The following tables are quality assurance summaries grouped by analyte type. These tables only contain data where the quality assurance was outside of acceptable criteria limits. Note: For non-detects when method detection limit was provided to DEQ in the electronic data delivery form, calculations in this summary table may appear inaccurate. See Full Split Sample Report tables for method reporting limits.
