...
#source("QC_Issue.R")
#logo <- "DEQ-logo-color-notransp-horiz750x156.png"
source("C:/Users/cthomas/Documents_local/local_R_resources/Split_Code/ParamGrp_Function.R")
source("C:/Users/cthomas/Documents_local/local_R_resources/Split_Code/QC_Issue.R")
logo <- "C:/Users/cthomas/Documents_local/local_R_resources/Split_Code/DEQ-logo-color-notransp-horiz750x156.png"
```
...
if(unique(spltorg$Project1)=="Statewide Groundwater Monitoring") {
...
Data submitted to DEQ may have been reported down to the Limit of Detection (LOD). In these cases, the Limit of Quantitation (LOQ) is included in the report under LOQ, but the results will include any detections below the LOQ and above the LOD. These detections will be qualified with a J flag. Non-detects in the result field will be indicated as less than the LOD limit (<LOD).
...
if(unique(spltorg$Project1)=="Statewide Groundwater Monitoring") {cat(spltorgnm, "Supplied level II (Results and data QA/QC) reports from",paste(as.character(spltlabnm),collapse="/"),
...
if(unique(spltorg$Project1)=="Effluent Monitoring"|unique(spltorg$Project1=="Statewide Groundwater Monitoring")) {cat("
