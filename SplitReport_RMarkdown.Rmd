...
acceptable when the difference between the samples is less than twice the MRL. Note that even if a split lab reports to the Method Detection Limit (DL), the split lab's MRL will be used if the result is between the MRL and MDL (also known as a 'j flag' result)
